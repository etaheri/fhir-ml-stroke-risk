...
const fetchPatient = async (id) =>
  (await fetch(`${import.meta.env.VITE_SOLID_APP_HAPI_URL}/fhir/Patient/${id}`)).json();

const fetchObservations = async (id) =>
  (
    await fetch(`${import.meta.env.VITE_SOLID_APP_HAPI_URL}/fhir/Observation?subject=Patient/${id}`)
  ).json();

const fetchConditions = async (id) =>
  (
    await fetch(`${import.meta.env.VITE_SOLID_APP_HAPI_URL}/fhir/Condition?subject=Patient/${id}`)
  ).json();
